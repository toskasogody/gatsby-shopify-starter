...
import { productType } from './documents/product';  // Ensure only one import for productType
...
import { productVariantType } from './documents/productVariant';  // No need to re-import productType

const documents = [
  collectionType,
  colorThemeType,
  pageType,
  productType,  // Ensure this is included only once
  productVariantType,
];
